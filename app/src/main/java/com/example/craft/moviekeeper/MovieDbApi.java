...
import com.example.craft.moviekeeper.rest.MovieService;
import com.example.craft.moviekeeper.rest.ReviewResponse;
import com.example.craft.moviekeeper.rest.VideoResponse;
...
public class MovieDbApi {
    ...
    public void searchMovie(String movie, @Nullable final MovieListListener listener) {

        getMovieService().searchMovie(sApiKey, movie, new Callback<MovieListResponse>() {
            @Override
            public void success(MovieListResponse response, Response httpResponse) {
                Log.d(TAG, "Number of movies found: " + response.getTotalResults());
                if (listener != null) {
                    listener.success(response);
                }
            }
